...
| 鷹峰ジン | jin_neutral.png, jin_business_smile.png, jin_irritated.png, jin_defeated.png | reference-polished |
...
| game/images/portraits/portrait_jin.png | 会話窓用・ジン顔アップ | reference-polished |
