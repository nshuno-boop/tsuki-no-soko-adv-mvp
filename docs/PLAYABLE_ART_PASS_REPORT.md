...
- 会話ウィンドウ、名前欄、選択肢に制作済みUI画像を接続した。Player View QA後は、左端の見切れリスクを直し、会話窓左側へ話者の顔アップを追加した。名前欄はセリフ欄内に収め、浮いた印象を抑えた。
...
- 会話画面: テキストボックスと名前欄を細線・角飾り・シアン発光のUIに再接続した。名前欄と本文をセリフ欄内へ収め、左側に顔アップを出すことで、本文と表情を同時に追いやすくした。
