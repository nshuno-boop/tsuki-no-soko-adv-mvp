...
- タイトル画面: 専用背景、ロゴ、縦並びメニューを追加した。
- 会話画面: テキストボックスと名前欄を本素材寄りUIに接続した。
...
- 調査UI: 証拠カード、タイムライン、ALMAログのフレーム画像を高密度化した。

## まだプレースホルダーのままのもの

- BGM/SEは未実装。
- セーブ/ロード/設定画面はRen'Py標準寄りのまま。
- 立ち絵は同一生成方針で揃えたプレイアブル素材であり、商業完成版の最終手描き素材ではない。
